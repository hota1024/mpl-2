...
export class MathMod extends Module {
  ...
  onLoad(runtime: IRuntime): void {
    ...
    runtime.addConstant(p('LN2'), Math.PI)
    runtime.addConstant(p('LN10'), Math.PI)
    runtime.addConstant(p('LOG2E'), Math.PI)
    runtime.addConstant(p('LOG10E'), Math.PI)
    runtime.addConstant(p('PI'), Math.PI)
    runtime.addConstant(p('SQRT1_2'), Math.PI)
    runtime.addConstant(p('SQRT2'), Math.PI)
